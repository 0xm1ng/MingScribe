...
| 文件 | 体积 | 说明 |
|---|---|---|
| `MingScribe_0.2.0_x64-setup.exe` | 1.84 MB | 常规安装程序，推荐 |
| `MingScribe_0.2.0_x64_en-US.msi` | 2.76 MB | 适合企业批量部署 |
...
| 产物 | 体积 | 说明 |
|---|---|---|
| `MingScribe_0.2.0_x64-setup.exe`（nsis） | 1.84 MB | 常规安装程序，推荐 |
| `MingScribe_0.2.0_x64_en-US.msi`（msi） | 2.76 MB | 适合企业批量部署 |
